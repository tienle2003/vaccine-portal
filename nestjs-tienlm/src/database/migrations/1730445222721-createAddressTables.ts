...
export class CreateAddressTables1730445222721 implements MigrationInterface {
  name = 'CreateAddressTables1730445222721';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`ward\` (\`id\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`districtId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
